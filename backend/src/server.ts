...
async function saveSessionState(sessionId: string, userId: number | null, state: any) {
    console.log(`[Backend] Saving session ${sessionId} state:`, state.status);
    try {
...
const GOOGLE_REDIRECT_URI = process.env.GOOGLE_REDIRECT_URI || 'http://localhost:3001/auth/google/callback'; // Points to backend
